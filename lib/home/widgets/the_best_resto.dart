...
class TheBestResto extends StatelessWidget {
  const TheBestResto({
    Key? key,
    required this.size,
  }) : super(key: key);
    ...
    return Container(
      ...
      child: Column(
          ...
          StreamBuilder<QuerySnapshot>(
            stream: pubStream.where('theme', isEqualTo: 'publicite').snapshots(),
                ...
                return Container(
                  ...
                  child: Column(
                    children: List.generate(snapshot.data!.docs.length, (index) {
                      String id = snapshot.data!.docs[index]['idresto'].toString();
