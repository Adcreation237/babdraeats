import 'package:babdraeats/commandes/note_livreur.dart';
import 'package:babdraeats/home/resto_list.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:flutter/material.dart';

class CommandDeliviring extends StatelessWidget {
  const CommandDeliviring({
    Key? key,
    ...
    return RefreshIndicator(
      ...
      child: FutureBuilder<QuerySnapshot>(
        future: proStream
            ...
            .where('newstatut', isEqualTo: "Livraison")
            .get(),
